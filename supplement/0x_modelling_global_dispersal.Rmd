...
![](figures/fig_global_dispersal.png)
...
![**Little to no change in ecological outcomes when implementing global dispersal.**](figures/fig_eco_change_global.png){ width=70% }
